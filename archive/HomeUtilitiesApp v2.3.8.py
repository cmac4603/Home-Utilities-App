...
class BElGenLiveGraph(Screen):
    def __init__(self, **kwargs):
        ...
        graph = Graph(xlabel='Time(s)', ylabel='Volts(VDC)', x_ticks_minor=2,
                      x_ticks_major=2.5, y_ticks_major=1,
                      y_grid_label=True, padding=15, x_grid_label=True,
                      x_grid=True, y_grid=True, xmin=-0, xmax=10, ymin=-10,
                      ymax=10)
