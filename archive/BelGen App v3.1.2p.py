...
class Weather(Screen):
    def wx_forecast(self):
        ...
        w = str(observation.get_weather())
        w = w.rpartition('=')[2]
        w = w.replace('>', '')
        #return str(r'/Users/colinmacrae/Documents/Programming/HomeUtilities/none.png')
        #t = w.get_reference_time(timeformat='iso')
        if w == 'clouds':
            print ('clouds')
            return str(r'/Users/colinmacrae/Documents/Programming/HomeUtilities/clouds.png')
        else:
            print (w + ' not found')
            return str(r'/Users/colinmacrae/Documents/Programming/HomeUtilities/none.png')
